...
export default function MakeItYours(){
  ...
  return <main className="app interviewApp">
    <header><a href="/">Upwards</a><div><span>Make it yours</span><button onClick={reset}>Start over</button></div></header>
