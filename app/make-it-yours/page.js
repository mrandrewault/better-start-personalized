...
const primaryDoorwayIds=["music-on","team","eat","works","outside","business","movie","read","design","active","animals","giving"];
...
export default function MakeItYours(){
  ...
  return <main className="app interviewApp">
    ...
    <footer><span>No account connections. No setup homework.</span><span>Personalized V6 · Saved privately in this browser</span></footer>
  </main>
}
